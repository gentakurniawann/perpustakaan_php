                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_POST["cari"])) {
                                ...
                                $query_pinjam= mysqli_query($koneksi,"select * from peminjaman_buku join siswa on siswa.id_siswa=peminjaman_buku.id_siswa join kelas on siswa.id_kelas=kelas.id_kelas");
                            }
