                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_POST["cari"])) {
                                ...
                                $cari=$_POST['cari'];
                                $query_siswa= mysqli_query($koneksi,"select * from siswa join kelas on kelas.id_kelas=siswa.id_kelas where siswa.id_siswa like '%$cari%' or siswa.nama_siswa like '%$cari%' or kelas.nama_kelas like '%$cari%'");
                            }else{
